...
//      version:		2009Q1V1
//      comment:		
//      configuration:	 -instname CacheBank -words 256 -bits 6 -frequency 1 -ring_width 4.0 -mux 8 -write_mask off -wp_size 8 -top_layer "met5-8" -power_type rings -horiz met1 -vert met2 -cust_comment "" -bus_notation on -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND -drive 6 -dpccm on -asvm on -corners ff_1p32v_m40c,ff_1p65v_125c,tt_1p2v_25c,ss_1p08v_125c
//
//      Verilog model for Synchronous Dual-Port Ram
//
//      Instance Name:              CacheBank
//      Words:                      256
//      Bits:                       6
//      Mux:                        8
//      Drive:                      6
...
//      Test Muxes                  Off
//
//      Creation Date:  2019-04-24 16:31:42Z
//      Version: 	2009Q1V1
//
